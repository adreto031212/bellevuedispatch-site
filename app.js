(function(){
  ...
  f.addEventListener('submit',function(e){
    ...
    .then(function(j){ if(j&&j.ok!==false){m.className='msg ok';m.textContent="Check your inbox. Click the confirmation link and Thursday's issue is yours.";f.reset();} else {throw new Error(j&&j.error||'error')} })
